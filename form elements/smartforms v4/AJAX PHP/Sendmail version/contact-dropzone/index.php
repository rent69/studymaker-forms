            ...
            <div class="smart-forms smart-container wrap-2">
                ...
                <form method="post" action="php/smartprocess.php" id="smart-form" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        <div class="section dropzone-container">
                            <div class="dropzone" id="myDropzone">
                                <h3 class="dz-drop-title"> Drop files here or </h3>
                                <p class="dz-clicker"> <span> <i class="fa fa-plus-circle"></i> Browse files </span> </p>                                                            
                                <div class="fallback">
                    ...
                    <div class="form-footer">
                        <button type="button" data-btntext-sending="Sending..." id="submit-all" class="button btn-primary">Send Form</button>
