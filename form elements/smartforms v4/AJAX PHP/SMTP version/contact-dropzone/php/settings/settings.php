<?php
	...
	/* file validation settings please dont chnage unless you know
	 *
	-------------------------------------------------------------------- */
	$file_folder 			= 	'../smuploads/';
	$file_unique_id 		= 	uniqid();
	$file_extensions 		= 	array(".jpg",".jpeg",".pjpeg",".png",".gif",".bmp",".tiff");
	$file_upload_size 		= 	'2085760';
	$removeFilesUploaded	= 	false;
